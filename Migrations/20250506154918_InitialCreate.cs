        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountOrCardNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CouponUserLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CouponUserLists_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CouponUserLists_Coupons_CouponId",
                        column: x => x.CouponId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LocationRegions_LocationCountries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Locations_LocationRegions_RegionId",
                        column: x => x.RegionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelayedDateFrom = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponUserListId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CouponUserLists_CouponId",
                table: "CouponUserLists",
                column: "CouponId");

            migrationBuilder.CreateIndex(
                name: "IX_CouponUserLists_UserId",
                table: "CouponUserLists",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_LocationRegions_CountryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CouponUserListId",
                table: "Orders",
